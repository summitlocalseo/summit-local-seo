...
export const metadata = {
  ...
  description:
    "Summit aide les artisans et indépendants de Liège à apparaître en tête de Google et Google Maps. Audit de visibilité locale gratuit, sans engagement.",
  alternates: { canonical: '/liege' },
  openGraph: {
    title: 'Référencement Local à Liège — Summit Local SEO',
    description:
      "Summit aide les artisans et indépendants de Liège à apparaître en tête de Google et Google Maps. Audit de visibilité locale gratuit, sans engagement.",
    url: '/liege',
  },
      ...
      <section className="hero-dark hero-tall" style={{ backgroundImage: 'linear-gradient(90deg, rgba(7,70,68,0) 0%, rgba(7,70,68,0.35) 100%), linear-gradient(120deg, rgba(18,22,24,0.55) 0%, rgba(24,30,32,0.4) 48%, rgba(30,38,40,0.2) 100%), url(\'/assets/img/hero-bg.jpg\')' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1.15fr 0.85fr', gap: '80px', alignItems: 'center', position: 'relative', zIndex: '2', padding: '0' }}>
          <div>
            ...
            <h1 style={{ fontSize: '46px', letterSpacing: '-1.8px', lineHeight: '1.05', color: '#fff', margin: '20px 0 0' }} data-fr="Soyez trouvé en premier à Liège." data-en="Get found first in Liège.">Soyez trouvé en premier à Liège.</h1>
