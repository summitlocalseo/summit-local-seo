...
export const metadata = {
  title: { absolute: 'Référencement Local à Namur — Summit Local SEO' },
  description:
    "Summit aide les artisans et indépendants de Namur à apparaître en tête de Google et Google Maps. Audit de visibilité locale gratuit, sans engagement.",
  alternates: { canonical: '/namur' },
  openGraph: {
    title: 'Référencement Local à Namur — Summit Local SEO',
    description:
      "Summit aide les artisans et indépendants de Namur à apparaître en tête de Google et Google Maps. Audit de visibilité locale gratuit, sans engagement.",
    url: '/namur',
  },
      ...
      <section className="hero-dark hero-tall" style={{ backgroundImage: 'linear-gradient(90deg, rgba(7,70,68,0) 0%, rgba(7,70,68,0.55) 100%), linear-gradient(120deg, rgba(18,22,24,0.92) 0%, rgba(24,30,32,0.78) 48%, rgba(30,38,40,0.55) 100%), url(\'/assets/img/about-hero-bg.jpg\')', backgroundPosition: 'center 75%' }}>
        <div className="container" style={{ display: 'grid', gridTemplateColumns: '1.15fr 0.85fr', gap: '80px', alignItems: 'center', position: 'relative', zIndex: '2', padding: '0' }}>
          <div>
            ...
            <h1 style={{ fontSize: '46px', letterSpacing: '-1.8px', lineHeight: '1.05', color: '#fff', margin: '20px 0 0' }} data-fr="Soyez trouvé en premier à Namur." data-en="Get found first in Namur.">Soyez trouvé en premier à Namur.</h1>
